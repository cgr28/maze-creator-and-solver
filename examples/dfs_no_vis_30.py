#!/usr/bin/env python3
# creates a size 30 maze with a dfs solution, but excludes visited cells
import sys
sys.path.append(".")
...
solution_path, _ = MazeSolvers.dfs(maze, START, END)  # returns list of cells in the dfs solution

draw_maze(maze, solution_path, output_file="./examples/dfs_no_vis_30.svg") # draws a maze with a solution but excludes the cells visited by the dfs